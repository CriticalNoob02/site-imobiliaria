...
export default function MenuToogle({title,link,uuids}:MenuToogleProps) {
    ...
    return (
        <div className="w-full h-full flex flex-row-reverse pr-10 items-center select-none">
            ...
            <div>
                <button className="p-3 text-lg font-semibold transition text-slate-100 rounded-lg bg-lime-600 hover:bg-lime-500 hover:shadow-lg hover:shadow-lime-600/50 hover:-translate-y-0.5 ">
